...
urlpatterns = [
    url(r'^account_list/$', login_required(views.AccountListView.as_view()), name = 'account_list'),
    url(r'^account_history/(?P<account_id>\d+)/$', login_required(views.AccountHistoryView.as_view()), name = 'account_history'),
    url(r'^account_history/$', login_required(views.AccountHistoryView.as_view()), name = 'account_histories'),
